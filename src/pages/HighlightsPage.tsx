...
const StackImg = require('../resource/projectsCard/Stack.png')
    ...
    return(
        ...
        exit="exit">
            <div className="max-w-2xl mx-10 w-full">
                ...
                <div className=" mb-6 text-ui-main font-plex text-sm font-light self-start"> Click to learn more.</div>
                ...
                <ProjectCard title="Freshkeep" imgSrc={KeepfreshImg} description="An IoT product that turns any fridge into a smart fridge. In this group project I acted as the tech lead." extLink={"https://miro.com/app/board/uXjVOjkub3s=/"}></ProjectCard>
                    ...
                    <ProjectCard title="Stack" imgSrc={StackImg} description="A UI/UX time management app prototype I made with Figma. It all stated with a vague client goal of 'reducing stress in life'." extLink={"https://www.behance.net/gallery/152638193/Stack-Time-Management-Game-Prototype"}></ProjectCard>
